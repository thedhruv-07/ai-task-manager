...
function App() {
  ...
  useKeyboardShortcuts({
    onFocusInput: () => taskInputRef.current?.focusInput(),
    onFocusSearch: () => searchRef.current?.focusSearch(),
    onAISuggest: () => taskInputRef.current?.triggerAI(),
  });
    ...
    <div className="min-h-screen overflow-x-hidden bg-gradient-to-br from-slate-100 via-gray-100 to-slate-200 dark:from-gray-900 dark:via-gray-900 dark:to-black px-3 sm:px-4 py-4 transition-colors duration-300">
      <div className="max-w-xl mx-auto w-full">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-6 sm:mb-8">
          <h1 className="text-3xl sm:text-4xl font-bold tracking-tight bg-gradient-to-r from-black to-gray-500 dark:from-white dark:to-gray-400 bg-clip-text text-transparent">
            AI Task Manager
          </h1>
          <ThemeToggle />
        </div>
